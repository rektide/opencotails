...
async function historyFixture(): Promise<{ readonly directory: string; readonly path: string }> {
  ...
  fixture.database.exec(`
    ...
    insert into session_message values
      ('m_user', 'ses_b', 'user', 0, 1, 1, '{}'),
      ('m_assistant', 'ses_b', 'assistant', 1, 2, 2, '{}'),
      ('m_synthetic', 'ses_b', 'synthetic', 2, 3, 3, '{}'),
      ('m_system', 'ses_b', 'system', 3, 4, 4, '{}'),
      ('m_skill', 'ses_b', 'skill', 4, 5, 5, '{}'),
      ('m_shell', 'ses_b', 'shell', 5, 6, 6, '{}'),
      ('m_compaction', 'ses_b', 'compaction', 6, 7, 7, '{}'),
      ('m_c', 'ses_c', 'user', 0, 8, 8, '{}');
